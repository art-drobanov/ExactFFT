    ...
    class ExactFFT_test
    {
       private static void Main(string[] args)
       {
           ...
           bool useTaperWindow, recoverAfterTaperWindow,
                useNorm, direction, usePolyphase, isMirror, isComplex;
           ...
           Console.WriteLine("ExactFFT TEST \"C#\" 8.00, (c) TESLA, 2014");
           ...
           isComplex = false;
           ExactFFT.CosTW cosTW = ExactFFT.CosTW.BLACKMAN_HARRIS_92dbPS;
           fftObj = ExactFFT.CFFT_Constructor_Cosine(frameWidth, cosTW, polyDiv2, windowStep, isComplex);
